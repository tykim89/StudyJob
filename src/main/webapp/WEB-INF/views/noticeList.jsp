...
<hr>
	...
	<div align="center">
		<form name="frmPaging" method="get" action="${pageContext.request.contextPath }/controller/noticeList.do">
	...
	<div style="display:inline" >
       <form name="searchform" method="post" 
       		action="${pageContext.request.contextPath }/controller/noticeSearch.do"
			...
			<input type="text" size="70" name="searchVal" value=""/>
