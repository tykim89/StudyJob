...
<div align="center">
	...
	<table border=1 cellpadding="5" cellspacing="0">
		...
		<c:forEach items="${studyAreaList}" var="s">
			<tr>
				<td>${s.study_no }</td>
	...
	<br>
	<div align="center">
		<form name="frmPaging" method="post" action="${pageContext.request.contextPath }/controller/studyAreaSearch.do">
			<input type="hidden" name="study_area" value="${param.study_area}" />
			<input type="hidden" name="study_rigion" value="${param.study_rigion }" />
	...
	<div align="center">
		...
		<div align="center">
		<form action="${pageContext.request.contextPath }/controller/writeForm"
			method="post">
