...
<div  align="center">
	...
	<form>
		...
		<c:forEach items="${studyCategory}" var="s">
			<tr>
				<td>${s.study_no }</td>
		...
		<div align="center">
		<form name="frmPaging" method="get" action="${pageContext.request.contextPath }/controller/studyCategory.do">
			<input type="hidden" name="start" value=""/>
			<input type="hidden" name="end" value=""/>
			<input type="hidden" name="nowPage" value=""/>
			<input type="hidden" name="study_category" value="${study_category }"/>
